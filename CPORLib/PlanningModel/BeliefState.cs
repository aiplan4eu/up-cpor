    ...
    public class BeliefState
    {
        ...
        */
        ...
        public State WriteTaggedDomainAndProblem(PartiallySpecifiedState pssCurrent, List<State> lStates, DeadendStrategies dsStrategy, out int cTags, out MemoryStream msModels)
        {
            ...
            {
                /*
                Domain domain = Problem.Domain.CreateTaggedDomain(dTags, Problem, null);
                msDomain = domain.WriteSimpleDomain(true, false);

                BUGBUG;//compare the domains generated by the two calls and see how they differ
                */
